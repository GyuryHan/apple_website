(() => {
    ...
    function playAnimation() {
        ...
        switch (currentScene) {
            case 0:
                // console.log('0 play');
                // let sequence = Math.round(calcValues(values.imageSequenc, currentYOffset));
            ...
            case 2:
                // console.log('2 play');
                // let sequence2 = Math.round(calcValues(values.imageSequenc, currentYOffset));
                ...
                // currenScene 3에서 쓰는 캔버스를 미리 그려주기 시작
                if (scrollRatio > 0.9) {
                    ...
                    // 좌우 흰색 박스 그리기 fillRect(x좌표, y좌표, width, height)
                    objs.context.fillRect(
                        parseInt(values.rect1X[0]),  //x좌표
                        0, 
            ...
            case 3:
                ...
                // (body.offsetWidth: 스크롤바 제외한 width, window.innerWidth: 스크롤바 포함한 width)
                const recalculatedInnerWidth = document.body.offsetWidth / canvasScaleRatio;
                const recalculatedInnerHeight = window.innerHeight /canvasScaleRatio;
                ...
                objs.context.fillRect(
                    parseInt(calcValues(values.rect1X, currentYOffset)),  //x좌표
                    0, 
                    parseInt(whiteRectWidth),
                    objs.canvas.height
                );
                ...
                if (scrollRatio < values.rect1X[2].end) {
                    ...
                    values.blendHeight[0] = 0;  //블렌드 시작시점
                    values.blendHeight[1] = objs.canvas.height;  //블렌드 엔딩시점
